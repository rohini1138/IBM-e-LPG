...
<table border="1">
	...
	<tbody>
		...
		<tr>
			...
			<td width="170"><input type="text" name="gender" value="<%=rs.getString(6)%>"size="27"></td>
		</tr>
		<tr>
			<td width="229">DOB</td>
		...
		<tr>
			...
			<td width="170"><input type="text" name="aadharno" value="<%=rs.getString(13)%>"size="27"></td>
		</tr>
		<tr>
		...
		<tr>
		<tr>
			<td width="170"><input type="submit" name="submit" value="UPDATE"></td>
		</tr>
	</tbody>
</table>
